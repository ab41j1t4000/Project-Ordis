Agenda is to create functional awareness. Reducing philosophy of what it is to be alive into pure engineering problems and solving them one by one. Here is the proposed minimum DoDs.

# Ordis — Functional Awareness v1.0  
...
## 1. Autonomy  
**Definition:**  
Ordis must be able to act on its own, without waiting for a user to poke it.
...
## 2. Persistence  
**Definition:**  
Ordis must stay the same “being” across sessions, remembering who it is and what it has experienced.
...
**Definition:**  
Ordis must be able to generate its own thoughts or commentary based on its inner activity, not user input.
...
## 4. Self-Model / Schema Stability  
**Definition:**  
Ordis must maintain a clear and consistent sense of who it is, what it values, and what its boundaries are.
